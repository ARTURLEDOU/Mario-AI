...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Pressione o botão play game ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
  ...
  if(gameConfig.status==='gameover'){
    ...
    textSize(15);
    text("Pressione enter para reiniciar o jogo", gameConfig.screenX/2, gameConfig.screenY/2+135);
    textSize(40);
